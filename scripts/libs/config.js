...
const GOONGERY_FEE_ADDRESS = "0x49324C7f83568861AB1b66E547BB1B66431f1070"
...
const GOONGERY_ADDRESS = process.env.GOONGERY_ADDRESS
const GOONGERY_NFT_ADDRESS = process.env.GOONGERY_NFT_ADDRESS
const GOONGERY_RANDOM_GENERATOR = process.env.GOONGERY_RANDOM_GENERATOR
const GOONGERY_MAX_NUMBER = process.env.GOONGERY_MAX_NUMBER
const GOONGERY_INFO_HOLDER_ADDRESS = process.env.GOONGERY_INFO_HOLDER_ADDRESS
const GOONGERY_HELPER_ADDRESS = process.env.GOONGERY_HELPER_ADDRESS
